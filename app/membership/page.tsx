...
export const metadata: Metadata = {
  ...
  description: "Main lebih sering, kumpulkan poin, main lagi di XPLAY Games lounge! Dapatkan reward waktu main gratis mulai dari PS4, PS4+, PS5, hingga VIP & VVIP Room menggunakan poin loyalty kamu.",
